...
$.getJSON("https://gist.githubusercontent.com/Mstuart712/65aebbc25921c4a1643c/raw/a40ed6022dd2034d30b0281724c491a249b88959/wretched-data.json", function(json) { 
    var myData = json;
...
var vis = d3.select("#college-picks"),
  ...
  createX = d3.scale.linear().range([MARGINS.left, WIDTH - MARGINS.right]).domain([1,13]),
  createY = d3.scale.linear().range([HEIGHT - MARGINS.top, MARGINS.bottom]).domain([0,500]),
